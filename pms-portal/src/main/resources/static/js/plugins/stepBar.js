...
var stepBar = {
    ...
    stepInfoWidthFun: function () {
        if (this.itemCount > 0) {
            this.barWidth = 100;
            this.itemWidth = Math.floor(this.barWidth / this.itemCount);
            //Math.floor(this.barWidth * 0.9 + this.itemWidth)
            this.bar.find(".ui-stepLayout").width("100%");
    ...
    percent: function () {
        ...
        console.log(_this.processWidth)
        if (_this.animation) {
            ...
            console.log(_this.curProcessWidth)
